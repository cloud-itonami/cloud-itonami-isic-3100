# Business Model: Manufacture of furniture
...
## Classification
- Repository: `cloud-itonami-isic-3100` ([github.com/cloud-itonami/cloud-itonami-isic-3100](https://github.com/cloud-itonami/cloud-itonami-isic-3100))
- ISIC Rev.5: `3100` — Manufacture of furniture
- Domain: `:furniture-manufacturing/plant-operations`
- Social impact: :worker-safety :consumer-safety :resource-efficiency
- Actor: `:furniture-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :furniture-manufacturing/plant-operations — who wants
a governed execution scaffold they own instead of renting a closed SaaS.

## Offer
The actor coordinates the :intake :log :schedule :hazard :ship :audit pipeline behind an independent Governor: the
...
One managed tenant (:furniture-manufacturing/plant-operations):
...
- Do not bypass the `:furniture-plant-operations-governor` for production decisions.
