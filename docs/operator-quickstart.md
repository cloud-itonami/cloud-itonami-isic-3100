# Operator Quickstart — Manufacture of furniture

Shortest path from clone to a verified local dry-run for **ISIC 3100** (`cloud-itonami-isic-3100`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3100.git
cd cloud-itonami-isic-3100
```
...
- Blueprint governor key: `furniture-plant-operations-governor`
- Likely source path: `furnituremfg.governor.cljc`
