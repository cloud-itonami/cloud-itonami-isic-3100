(ns furnituremfg.phase
  "Phase 0->3 staged rollout for the furniture-manufacturing plant-
  ...
  consequence (a cutting/sanding/finishing-line maintenance window
  means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `furnituremfg.governor`'s `line-finalize-blocked-violations`
  HARD-blocks finalize attempts unconditionally, and the confidence/
...
(defn verdict->disposition
  "Map a Furniture Plant Operations Governor verdict to a base
